...
set Library     "hls"
set IPName      "hardware_encoding"
set Version     "1.0"
set DisplayName "Hardware_encoding"
set Revision    "2113328938"
...
set xo_kernel_name "hardware_encoding"
set xo_kernel_files {/mnt/castor/seas_home/l/lize1/ese532_final/project/Server/LZW_new.cpp}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/mnt/castor/seas_home/l/lize1/ese532_final/project/final_project/solution1"
set debug_dir "/mnt/castor/seas_home/l/lize1/ese532_final/project/final_project/solution1/.debug"
set xo_hls_files_dir "/mnt/castor/seas_home/l/lize1/ese532_final/project/final_project/solution1/impl/ip/hls_files"
set hdl_module_list {hardware_encoding_temp_output
...
set kernel_xo "/mnt/castor/seas_home/l/lize1/ese532_final/project/hardware_encoding.xo"

## Variables
set Top "hardware_encoding"
set TopNoPrefix "hardware_encoding"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 s1_1 W 0x0 "Data signal of s1" {{0 32 s1 W 0 "Bit 31 to 0 of s1"}}} {0x14 s1_2 W 0x0 "Data signal of s1" {{0 32 s1 W 0 "Bit 63 to 32 of s1"}}} {0x1c output_r_1 W 0x0 "Data signal of output_r" {{0 32 output_r W 0 "Bit 31 to 0 of output_r"}}} {0x20 output_r_2 W 0x0 "Data signal of output_r" {{0 32 output_r W 0 "Bit 63 to 32 of output_r"}}} {0x28 lzw_size_1 W 0x0 "Data signal of lzw_size" {{0 32 lzw_size W 0 "Bit 31 to 0 of lzw_size"}}} {0x2c lzw_size_2 W 0x0 "Data signal of lzw_size" {{0 32 lzw_size W 0 "Bit 63 to 32 of lzw_size"}}} {0x34 input_size_1 W 0x0 "Data signal of input_size" {{0 32 input_size W 0 "Bit 31 to 0 of input_size"}}} {0x38 input_size_2 W 0x0 "Data signal of input_size" {{0 32 input_size W 0 "Bit 63 to 32 of input_size"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_HP1 m_axi_HP3"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_HP1 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_HP1"
        data_width "32"
        param_prefix "C_M_AXI_HP1"
    ...
    m_axi_HP3 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_HP3"
        data_width "32"
        param_prefix "C_M_AXI_HP3"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
