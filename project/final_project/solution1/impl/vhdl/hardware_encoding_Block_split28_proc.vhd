...
entity hardware_encoding_Block_split28_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of hardware_encoding_Block_split28_proc is 
...
attribute shreg_extract : string;
    ...
    signal compress_size_0_blk_n : STD_LOGIC;
    signal lzw_size_blk_n : STD_LOGIC;
    signal HP0_blk_n_AW : STD_LOGIC;
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal HP0_blk_n_W : STD_LOGIC;
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal HP0_blk_n_B : STD_LOGIC;
    signal ap_CS_fsm_state71 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state71 : signal is "none";
    signal compress_size_0_read_reg_96 : STD_LOGIC_VECTOR (31 downto 0);
    signal HP0_addr_reg_101 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln302_fu_86_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state71) and (m_axi_HP0_BVALID = ap_const_logic_1))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, compress_size_0_empty_n, lzw_size_empty_n, m_axi_HP0_AWREADY, m_axi_HP0_WREADY, m_axi_HP0_BVALID, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state71)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((lzw_size_empty_n = ap_const_logic_0) or (compress_size_0_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_HP0_AWREADY = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (m_axi_HP0_WREADY = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_state71 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state71) and (m_axi_HP0_BVALID = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state71;
                end if;
    ...
    HP0_blk_n_AW_assign_proc : process(m_axi_HP0_AWREADY, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            HP0_blk_n_AW <= m_axi_HP0_AWREADY;
        else 
            HP0_blk_n_AW <= ap_const_logic_1;
        end if; 
    end process;


    HP0_blk_n_B_assign_proc : process(m_axi_HP0_BVALID, ap_CS_fsm_state71)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state71)) then 
            HP0_blk_n_B <= m_axi_HP0_BVALID;
        else 
            HP0_blk_n_B <= ap_const_logic_1;
        end if; 
    end process;


    HP0_blk_n_W_assign_proc : process(m_axi_HP0_WREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            HP0_blk_n_W <= m_axi_HP0_WREADY;
        else 
            HP0_blk_n_W <= ap_const_logic_1;
        end if; 
    end process;
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, compress_size_0_empty_n, lzw_size_empty_n)
    begin
                ap_block_state1 <= ((lzw_size_empty_n = ap_const_logic_0) or (compress_size_0_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_done_reg, m_axi_HP0_BVALID, ap_CS_fsm_state71)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state71) and (m_axi_HP0_BVALID = ap_const_logic_1))) then 
    ...
    ap_ready_assign_proc : process(m_axi_HP0_BVALID, ap_CS_fsm_state71)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state71) and (m_axi_HP0_BVALID = ap_const_logic_1))) then 
    ...
    compress_size_0_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, compress_size_0_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            compress_size_0_blk_n <= compress_size_0_empty_n;
        else 
            compress_size_0_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    compress_size_0_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, compress_size_0_empty_n, lzw_size_empty_n)
    begin
        if ((not(((lzw_size_empty_n = ap_const_logic_0) or (compress_size_0_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            compress_size_0_read <= ap_const_logic_1;
        else 
            compress_size_0_read <= ap_const_logic_0;
        end if; 
    end process;


    lzw_size_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, lzw_size_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            lzw_size_blk_n <= lzw_size_empty_n;
        else 
            lzw_size_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    lzw_size_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, compress_size_0_empty_n, lzw_size_empty_n)
    begin
        if ((not(((lzw_size_empty_n = ap_const_logic_0) or (compress_size_0_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            lzw_size_read <= ap_const_logic_1;
        else 
            lzw_size_read <= ap_const_logic_0;
        end if; 
    end process;

    m_axi_HP0_ARADDR <= ap_const_lv64_0;
    m_axi_HP0_ARBURST <= ap_const_lv2_0;
    m_axi_HP0_ARCACHE <= ap_const_lv4_0;
    m_axi_HP0_ARID <= ap_const_lv1_0;
    m_axi_HP0_ARLEN <= ap_const_lv32_0;
    m_axi_HP0_ARLOCK <= ap_const_lv2_0;
    m_axi_HP0_ARPROT <= ap_const_lv3_0;
    m_axi_HP0_ARQOS <= ap_const_lv4_0;
    m_axi_HP0_ARREGION <= ap_const_lv4_0;
    m_axi_HP0_ARSIZE <= ap_const_lv3_0;
    m_axi_HP0_ARUSER <= ap_const_lv1_0;
    m_axi_HP0_ARVALID <= ap_const_logic_0;
    m_axi_HP0_AWADDR <= HP0_addr_reg_101;
    m_axi_HP0_AWBURST <= ap_const_lv2_0;
    m_axi_HP0_AWCACHE <= ap_const_lv4_0;
    m_axi_HP0_AWID <= ap_const_lv1_0;
    m_axi_HP0_AWLEN <= ap_const_lv32_1;
    m_axi_HP0_AWLOCK <= ap_const_lv2_0;
    m_axi_HP0_AWPROT <= ap_const_lv3_0;
    m_axi_HP0_AWQOS <= ap_const_lv4_0;
    m_axi_HP0_AWREGION <= ap_const_lv4_0;
    m_axi_HP0_AWSIZE <= ap_const_lv3_0;
    m_axi_HP0_AWUSER <= ap_const_lv1_0;

    m_axi_HP0_AWVALID_assign_proc : process(m_axi_HP0_AWREADY, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_HP0_AWREADY = ap_const_logic_1))) then 
            m_axi_HP0_AWVALID <= ap_const_logic_1;
        else 
            m_axi_HP0_AWVALID <= ap_const_logic_0;
        end if; 
    end process;


    m_axi_HP0_BREADY_assign_proc : process(m_axi_HP0_BVALID, ap_CS_fsm_state71)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state71) and (m_axi_HP0_BVALID = ap_const_logic_1))) then 
            m_axi_HP0_BREADY <= ap_const_logic_1;
        else 
            m_axi_HP0_BREADY <= ap_const_logic_0;
        end if; 
    end process;

    m_axi_HP0_RREADY <= ap_const_logic_0;
    m_axi_HP0_WDATA <= compress_size_0_read_reg_96;
    m_axi_HP0_WID <= ap_const_lv1_0;
    m_axi_HP0_WLAST <= ap_const_logic_0;
    m_axi_HP0_WSTRB <= ap_const_lv4_F;
    m_axi_HP0_WUSER <= ap_const_lv1_0;

    m_axi_HP0_WVALID_assign_proc : process(m_axi_HP0_WREADY, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (m_axi_HP0_WREADY = ap_const_logic_1))) then 
            m_axi_HP0_WVALID <= ap_const_logic_1;
        else 
            m_axi_HP0_WVALID <= ap_const_logic_0;
        end if; 
    end process;

        sext_ln302_fu_86_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_76_p4),64));

    trunc_ln_fu_76_p4 <= lzw_size_dout(63 downto 2);
end behav;
