...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /mnt/pollux/software/xilinx/2020.2/Vitis_HLS/2020.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /mnt/pollux/software/xilinx/2020.2/Vitis_HLS/2020.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /mnt/pollux/software/xilinx/2020.2/Vitis_HLS/2020.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /mnt/pollux/software/xilinx/2020.2/Vitis_HLS/2020.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hardware_encoding.autotvin.dat"
	set constFileTvOut       "hardware_encoding.autotvout.dat"
	set constFileHdlTvIn     "hardware_encoding.autohdltvin.dat"
	set constFileHdlTvOut    "hardware_encoding.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
