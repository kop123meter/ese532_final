...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hardware_encoding.autotvin_HP1.dat"
         "c.hardware_encoding.autotvin_s1.dat"
         "c.hardware_encoding.autotvin_output_r.dat"
         "c.hardware_encoding.autotvout_HP3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hardware_encoding.autotvout_HP3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
