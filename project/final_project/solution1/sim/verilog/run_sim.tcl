...
if {[file isfile hardware_encoding.autotvin.dat]} {
	file delete -force hardware_encoding.autotvin.dat
}

if {[file isfile hardware_encoding.autotvout.dat]} {
	file delete -force hardware_encoding.autotvout.dat
}
