...
//------------------------Parameter----------------------
`define TV_IN_HP1 "../tv/cdatafile/c.hardware_encoding.autotvin_HP1.dat"
`define TV_OUT_HP1 "../tv/rtldatafile/rtl.hardware_encoding.autotvout_HP1.dat"
 parameter HP1_ADDR_BITWIDTH = 32'd 64;
 parameter HP1_AWUSER_BITWIDTH = 32'd 1;
 parameter HP1_DATA_BITWIDTH = 32'd 32;
 parameter HP1_WUSER_BITWIDTH = 32'd 1;
 parameter HP1_ID_BITWIDTH = 32'd 1;
 parameter HP1_RUSER_BITWIDTH = 32'd 1;
 parameter HP1_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   64 + 64;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter HP1_C_DATA_BITWIDTH = 32'd 16;
parameter HP1_mem_depth = 32'd 16388;
parameter ReadReqLatency = 32'd 64;
parameter WriteReqLatency = 32'd 64;
// Input and Output
input clk;
input reset;
input  TRAN_HP1_AWVALID;
output  TRAN_HP1_AWREADY;
input [HP1_ADDR_BITWIDTH - 1 : 0] TRAN_HP1_AWADDR;
input [HP1_ID_BITWIDTH - 1 : 0] TRAN_HP1_AWID;
input [8 - 1 : 0] TRAN_HP1_AWLEN;
input [3 - 1 : 0] TRAN_HP1_AWSIZE;
input [2 - 1 : 0] TRAN_HP1_AWBURST;
input [2 - 1 : 0] TRAN_HP1_AWLOCK;
input [4 - 1 : 0] TRAN_HP1_AWCACHE;
input [3 - 1 : 0] TRAN_HP1_AWPROT;
input [4 - 1 : 0] TRAN_HP1_AWQOS;
input [4 - 1 : 0] TRAN_HP1_AWREGION;
input [HP1_AWUSER_BITWIDTH - 1 : 0] TRAN_HP1_AWUSER;
input  TRAN_HP1_WVALID;
output  TRAN_HP1_WREADY;
input [HP1_DATA_BITWIDTH - 1 : 0] TRAN_HP1_WDATA;
input [HP1_DATA_BITWIDTH/8 - 1 : 0] TRAN_HP1_WSTRB;
input  TRAN_HP1_WLAST;
input  TRAN_HP1_WID;
input [HP1_WUSER_BITWIDTH - 1 : 0] TRAN_HP1_WUSER;
input  TRAN_HP1_ARVALID;
output  TRAN_HP1_ARREADY;
input [HP1_ADDR_BITWIDTH - 1 : 0] TRAN_HP1_ARADDR;
input [HP1_ID_BITWIDTH - 1 : 0] TRAN_HP1_ARID;
input [8 - 1 : 0] TRAN_HP1_ARLEN;
input [3 - 1 : 0] TRAN_HP1_ARSIZE;
input [2 - 1 : 0] TRAN_HP1_ARBURST;
input [2 - 1 : 0] TRAN_HP1_ARLOCK;
input [4 - 1 : 0] TRAN_HP1_ARCACHE;
input [3 - 1 : 0] TRAN_HP1_ARPROT;
input [4 - 1 : 0] TRAN_HP1_ARQOS;
input [4 - 1 : 0] TRAN_HP1_ARREGION;
input  TRAN_HP1_ARUSER;
output  TRAN_HP1_RVALID;
input  TRAN_HP1_RREADY;
output [HP1_DATA_BITWIDTH - 1 : 0] TRAN_HP1_RDATA;
output  TRAN_HP1_RLAST;
output [HP1_ID_BITWIDTH - 1 : 0] TRAN_HP1_RID;
output [HP1_RUSER_BITWIDTH - 1 : 0] TRAN_HP1_RUSER;
output [2 - 1 : 0] TRAN_HP1_RRESP;
output  TRAN_HP1_BVALID;
input  TRAN_HP1_BREADY;
output [2 - 1 : 0] TRAN_HP1_BRESP;
output [HP1_ID_BITWIDTH - 1 : 0] TRAN_HP1_BID;
output [HP1_BUSER_BITWIDTH - 1 : 0] TRAN_HP1_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [HP1_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [HP1_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [HP1_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [HP1_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [HP1_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [HP1_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [HP1_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [HP1_DATA_BITWIDTH - 1 : 0] HP1_mem_0 [0: HP1_mem_depth - 1]; 
reg [HP1_DATA_BITWIDTH - 1 : 0] HP1_mem_1 [0: HP1_mem_depth - 1]; 
reg [HP1_DATA_BITWIDTH - 1 : 0] HP1_mem_2 [0: HP1_mem_depth - 1]; 
reg [HP1_DATA_BITWIDTH - 1 : 0] HP1_mem_3 [0: HP1_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [HP1_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [HP1_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [HP1_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_HP1_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_HP1_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_HP1_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_HP1_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_HP1_BRESP = BRESP_tmp;
assign TRAN_HP1_RDATA = RDATA_tmp;
assign TRAN_HP1_RRESP = RRESP_tmp;
assign TRAN_HP1_RLAST = RLAST_tmp;
assign TRAN_HP1_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = HP1_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
end

initial begin : initialize_HP1_mem
  integer i;
  for (i = 0; i < HP1_mem_depth; i = i + 1) begin
      HP1_mem_0[i] = 0;
      HP1_mem_1[i] = 0;
      HP1_mem_2[i] = 0;
      HP1_mem_3[i] = 0;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_HP1_AWREADY & TRAN_HP1_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_HP1_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_HP1_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_HP1_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_HP1_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_HP1_ARREADY & TRAN_HP1_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_HP1_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_HP1_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_HP1_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_HP1_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_HP1_WREADY & TRAN_HP1_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_HP1_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_HP1_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_HP1_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_HP1_AWVALID && TRAN_HP1_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_HP1_ARVALID && TRAN_HP1_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_HP1_WVALID && TRAN_HP1_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_HP1_WVALID && TRAN_HP1_WREADY && TRAN_HP1_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_HP1_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_HP1_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [HP1_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [HP1_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [HP1_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > HP1_mem_depth) begin
                $display ("/mnt/castor/seas_home/l/lize1/ese532_final/project/final_project/solution1/sim/verilog/AESL_axi_master_HP1.v: Write request address %d exceed AXI master HP1 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, HP1_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = HP1_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = HP1_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = HP1_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = HP1_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : HP1_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : HP1_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : HP1_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : HP1_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = HP1_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = HP1_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = HP1_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = HP1_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : HP1_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : HP1_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : HP1_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : HP1_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > HP1_mem_depth) begin
                $display ("/mnt/castor/seas_home/l/lize1/ese532_final/project/final_project/solution1/sim/verilog/AESL_axi_master_HP1.v: Read request address %d exceed AXI master HP1 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, HP1_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= HP1_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= HP1_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= HP1_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= HP1_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_HP1_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= HP1_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= HP1_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= HP1_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= HP1_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer HP1_bitwidth; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [HP1_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [HP1_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  HP1_bitwidth = HP1_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (HP1_bitwidth , factor);
  fp = $fopen(`TV_IN_HP1,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_HP1); 
      $finish; 
  end 
  token = read_token(fp); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [HP1_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < HP1_mem_depth; i = i + 1) begin 
          token = read_token(fp);
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : HP1_mem_0[i/factor] = mem_tmp;
                      1 : HP1_mem_1[i/factor] = mem_tmp;
                      2 : HP1_mem_2[i/factor] = mem_tmp;
                      3 : HP1_mem_3[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : HP1_mem_0[i] = mem_tmp;
                  1 : HP1_mem_1[i] = mem_tmp;
                  2 : HP1_mem_2[i] = mem_tmp;
                  3 : HP1_mem_3[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [HP1_DATA_BITWIDTH - 1: 0] = 0;
          end
