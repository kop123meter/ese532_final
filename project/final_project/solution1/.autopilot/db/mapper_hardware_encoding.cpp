...
extern "C" void apatb_hardware_encoding_hw(volatile void * __xlx_apatb_param_s1, volatile void * __xlx_apatb_param_output, volatile void * __xlx_apatb_param_lzw_size, volatile void * __xlx_apatb_param_input_size) {
  ...
  int __xlx_offset_param_input_size = 1;
  int __xlx_offset_byte_param_input_size = 1*4;
  ...
  vector<sc_bv<32> >__xlx_output_lzw_size__tmp_vec;
  for (int j = 0, e = 1; j != e; ++j) {
    __xlx_output_lzw_size__tmp_vec.push_back(((int*)__xlx_apatb_param_output)[j]);
  }
  int __xlx_size_param_output = 1;
  int __xlx_offset_param_output = 0;
  int __xlx_offset_byte_param_output = 0*4;
  for (int j = 0, e = 1; j != e; ++j) {
    __xlx_output_lzw_size__tmp_vec.push_back(((int*)__xlx_apatb_param_lzw_size)[j]);
  }
  int __xlx_size_param_lzw_size = 1;
  int __xlx_offset_param_lzw_size = 1;
  int __xlx_offset_byte_param_lzw_size = 1*4;
  int* __xlx_output_lzw_size__input_buffer= new int[__xlx_output_lzw_size__tmp_vec.size()];
  for (int i = 0; i < __xlx_output_lzw_size__tmp_vec.size(); ++i) {
    __xlx_output_lzw_size__input_buffer[i] = __xlx_output_lzw_size__tmp_vec[i].range(31, 0).to_uint64();
  }
  // DUT call
  hardware_encoding(__xlx_s1_input_size__input_buffer, __xlx_output_lzw_size__input_buffer, __xlx_offset_byte_param_s1, __xlx_offset_byte_param_output, __xlx_offset_byte_param_lzw_size, __xlx_offset_byte_param_input_size);
