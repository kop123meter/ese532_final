...
#define XHARDWARE_ENCODING_CONTROL_ADDR_SIZE_DATA     0x28
#define XHARDWARE_ENCODING_CONTROL_BITS_SIZE_DATA     32
#define XHARDWARE_ENCODING_CONTROL_ADDR_LEN_DATA      0x38
#define XHARDWARE_ENCODING_CONTROL_BITS_LEN_DATA      32
