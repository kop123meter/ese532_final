...
set C_modelArgList {
	...
	{ HP3 int 32 regular {axi_master 1}  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_assoc_lookup_fu_696", "Parent" : "0",
		"CDFG" : "assoc_lookup",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	hardware_encoding {
		...
		HP3 {Type O LastRead 84 FirstWrite 82}
